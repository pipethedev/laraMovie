        ...
        <div class="container mx-auto flex-col md:flex-row flex items-center justify-between px-4 py-6">
            <ul class="flex items-center flex-col md:flex-row">
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="#" class="hover:text-green-200">Movies</a>
                </li>
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="#" class="hover:text-green-200">TV Shows</a>
                </li>
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="#" class="hover:text-green-200">Actors</a>
                </li>
            </ul>
            <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown>
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#"><img alt="avatar" src="https://avatars3.githubusercontent.com/u/54484130?s=460&u=ba496c16089fab85322004a4daa921cf48790985&v=4" class="rounded-full w-8 h-8"></a>
                </div>
            </div>
        </div>
    </nav>
